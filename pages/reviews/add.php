...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="mb-6">
        <h2 class="font-bold text-3xl text-gray-900">
            <i class="fas fa-star text-yellow-500 mr-2"></i>Tulis Review
        </h2>
        <p class="text-gray-600 mt-2">
            Bagikan pengalaman Anda dan bantu orang lain!
            Anda akan mendapatkan <strong class="text-blue-600"><?php echo POINTS_PER_REVIEW; ?> poin</strong>.
        </p>
    </div>
            ...
            <form method="POST" action="" enctype="multipart/form-data" id="reviewForm">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-400 p-6 rounded-lg mb-6">
                    <h6 class="font-bold mb-3 text-gray-900">
                        <i class="fas fa-info-circle mr-2 text-blue-600"></i>Panduan Menulis Review
                    </h6>
                    <ul class="mb-0 text-sm text-gray-700 space-y-1 ml-4 list-disc">
